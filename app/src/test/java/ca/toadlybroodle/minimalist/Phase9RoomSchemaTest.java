...
public class Phase9RoomSchemaTest {
    ...
    private static final String ENTITY_DIR =
            "app/src/main/java/ca/toadlybroodle/minimalist/db/entity/";
    private static final String DAO_DIR =
            "app/src/main/java/ca/toadlybroodle/minimalist/db/dao/";
    private static final String DB_DIR =
            "app/src/main/java/ca/toadlybroodle/minimalist/db/";
