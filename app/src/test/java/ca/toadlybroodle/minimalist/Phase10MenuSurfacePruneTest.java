...
public class Phase10MenuSurfacePruneTest {
    ...
    public void profileFragmentStubDeleted() {
        ...
        assertFalse("ProfileFragment.java stub must be deleted after Phase 10.2 package rename",
                exists("app/src/main/java/ca/toadlybroodle/minimalist/ProfileFragment.java"));
    }
    ...
    public void appSettingsDropsAnalyticsMethods() {
        ...
        String src = read(
                "app/src/main/java/ca/toadlybroodle/minimalist/AppSettings.java");
    ...
    public void hostContractDropsProfileGetter() {
        String src = read("app/src/main/java/ca/toadlybroodle/minimalist/iface/HostContract.java");
        ...
        assertFalse("HostContract must not import ProfileFragment (Phase 10.4)",
                src.contains("import ca.toadlybroodle.minimalist.ProfileFragment"));
    }

    @Test
    public void mainActivityDropsProfileWiring() {
        String src = read("app/src/main/java/ca/toadlybroodle/minimalist/MainActivity.java");
    ...
    public void outlineTreeDropsProfileCall() {
        String src = read("app/src/main/java/ca/toadlybroodle/minimalist/OutlineTree.java");
