...
public class RootPackagePortTest {
    ...
    public void clipboardClassExists() {
        assertEquals("ca.toadlybroodle.minimalist.Clipboard",
    ...
    public void appSettingsClassExists() {
        assertEquals("ca.toadlybroodle.minimalist.AppSettings",
    ...
    public void outlineTreeClassExists() {
        assertEquals("ca.toadlybroodle.minimalist.OutlineTree",
    ...
    public void outlineRowViewClassExists() {
        assertEquals("ca.toadlybroodle.minimalist.OutlineRowView",
    ...
    public void indentManagerClassExists() {
        assertEquals("ca.toadlybroodle.minimalist.IndentManager",
    ...
    public void sublistRendererClassExists() {
        assertEquals("ca.toadlybroodle.minimalist.SublistRenderer",
    ...
    public void dateTimeUtilClassExists() {
        assertEquals("ca.toadlybroodle.minimalist.DateTimeUtil",
    ...
    public void newSublistDialogClassExists() {
        assertEquals("ca.toadlybroodle.minimalist.NewSublistDialog",
    ...
    public void drawerToggleClassExists() {
        assertEquals("ca.toadlybroodle.minimalist.DrawerToggle",
    ...
    public void sublistFragmentClassExists() {
        assertEquals("ca.toadlybroodle.minimalist.OutlineFragment",
    ...
    public void sublistFragmentImplementsOutlineHost() {
        ...
        assertTrue("OutlineFragment must implement OutlineHost",
                ifaces.contains("ca.toadlybroodle.minimalist.iface.OutlineHost"));
    }
    ...
    public void settingsDialogClassExists() {
        assertEquals("ca.toadlybroodle.minimalist.SettingsDialog",
    ...
    public void searchFragmentImplementsFragmentHost() {
        ...
        assertTrue("SearchFragment must implement FragmentHost",
                ifaces.contains("ca.toadlybroodle.minimalist.iface.FragmentHost"));
    }
    ...
    public void settingsFragmentClassExists() {
        assertEquals("ca.toadlybroodle.minimalist.SettingsFragment",
    ...
    public void mainActivityImplementsHostContract() {
        ...
        assertTrue("MainActivity must implement HostContract",
                ifaces.contains("ca.toadlybroodle.minimalist.iface.HostContract"));
    }
    ...
    public void mainActivityImplementsRowActionListener() {
        ...
        assertTrue("MainActivity must implement RowActionListener",
                ifaces.contains("ca.toadlybroodle.minimalist.iface.RowActionListener"));
    }
