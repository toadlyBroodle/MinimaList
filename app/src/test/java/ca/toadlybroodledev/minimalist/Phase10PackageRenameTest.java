...
/**
 * Phase 10.2: code rename `ca.toadlybroodledev.sublist` → `ca.toadlybroodledev.minimalist`.
 *
 * Covers four surfaces:
 *
 *  (a) build.gradle.kts namespace + applicationId
 *  (b) source-tree relocation: every file under app/src/main/java/ca/toadlybroodledev/minimalist/
...
public class Phase10PackageRenameTest {
    ...
    public void appBuildGradleUsesMinimalistNamespaceAndApplicationId() {
        ...
        assertTrue("namespace must be ca.toadlybroodledev.minimalist (Phase 10.2)",
                src.contains("namespace = \"ca.toadlybroodledev.minimalist\""));
        assertTrue("applicationId must be ca.toadlybroodledev.minimalist (Phase 10.2)",
                src.contains("applicationId = \"ca.toadlybroodledev.minimalist\""));
    ...
    public void mainSourceDirectoryRelocated() {
        assertTrue("new main src dir app/src/main/java/ca/toadlybroodledev/minimalist/ must exist",
                exists("app/src/main/java/ca/toadlybroodledev/minimalist"));
    ...
    public void testSourceDirectoryRelocated() {
        assertTrue("new test src dir app/src/test/java/ca/toadlybroodledev/minimalist/ must exist",
                exists("app/src/test/java/ca/toadlybroodledev/minimalist"));
    ...
    public void mainSourceFilesDeclareMinimalistPackages() {
        // Every Java file in the active main tree must declare a `package ca.toadlybroodledev.minimalist*` line.
        File mainRoot = new File(projectRoot(),
                "app/src/main/java/ca/toadlybroodledev/minimalist");
        walkAndAssertPackage(mainRoot, "ca.toadlybroodledev.minimalist");
    }

    @Test
    public void testSourceFilesDeclareMinimalistPackages() {
        File testRoot = new File(projectRoot(),
                "app/src/test/java/ca/toadlybroodledev/minimalist");
        walkAndAssertPackage(testRoot, "ca.toadlybroodledev.minimalist");
    }
    ...
    public void sublistDatabaseRenamedToMinimaListDatabase() {
        assertTrue("MinimaListDatabase.java must exist under db/",
                exists("app/src/main/java/ca/toadlybroodledev/minimalist/db/MinimaListDatabase.java"));
        assertFalse("SublistDatabase.java must be gone (renamed)",
                exists("app/src/main/java/ca/toadlybroodledev/minimalist/db/SublistDatabase.java"));
        String src = read(
                "app/src/main/java/ca/toadlybroodledev/minimalist/db/MinimaListDatabase.java");
    ...
    public void sublistFragmentRenamedToOutlineFragment() {
        assertTrue("OutlineFragment.java must exist at the new path",
                exists("app/src/main/java/ca/toadlybroodledev/minimalist/OutlineFragment.java"));
        assertFalse("SublistFragment.java must be gone (renamed to OutlineFragment)",
                exists("app/src/main/java/ca/toadlybroodledev/minimalist/SublistFragment.java"));
        String src = read(
    ...
    public void welcomeSublistFragmentRenamedToWelcomeFragment() {
        assertTrue("WelcomeFragment.java must exist at the new path",
                exists("app/src/main/java/ca/toadlybroodledev/minimalist/WelcomeFragment.java"));
        assertFalse("WelcomeSublistFragment.java must be gone (renamed)",
                exists(
                  "app/src/main/java/ca/toadlybroodledev/minimalist/WelcomeSublistFragment.java"));
        String src = read(
                "app/src/main/java/ca/toadlybroodledev/minimalist/WelcomeFragment.java");
    ...
    public void searchSublistFragmentRenamedToSearchFragment() {
        assertTrue("SearchFragment.java must exist at the new path",
                exists("app/src/main/java/ca/toadlybroodledev/minimalist/SearchFragment.java"));
        assertFalse("SearchSublistFragment.java must be gone (renamed)",
                exists(
                  "app/src/main/java/ca/toadlybroodledev/minimalist/SearchSublistFragment.java"));
        String src = read(
                "app/src/main/java/ca/toadlybroodledev/minimalist/SearchFragment.java");
    ...
    public void domainSublistTypesPreserved() {
        ...
        assertTrue("SublistEntity.java must still exist (domain type)",
                exists(
                  "app/src/main/java/ca/toadlybroodledev/minimalist/db/entity/SublistEntity.java"));
        assertTrue("SublistDao.java must still exist (domain type)",
                exists(
                  "app/src/main/java/ca/toadlybroodledev/minimalist/db/dao/SublistDao.java"));
        assertTrue("SublistRenderer.java must still exist (domain type)",
                exists(
                  "app/src/main/java/ca/toadlybroodledev/minimalist/SublistRenderer.java"));
        // NewSublistDialog creates a domain sublist; keep too.
        assertTrue("NewSublistDialog.java must still exist (domain creator)",
                exists(
                  "app/src/main/java/ca/toadlybroodledev/minimalist/NewSublistDialog.java"));
    }
    ...
    public void layoutMainUsesMinimalistViewTags() {
        ...
        assertTrue("activity_main.xml must reference minimalist.DrawerCustomLayout",
                xml.contains("ca.toadlybroodledev.minimalist.DrawerCustomLayout"));
        assertTrue("activity_main.xml must reference minimalist.OutlineFab",
                xml.contains("ca.toadlybroodledev.minimalist.OutlineFab"));
    ...
    public void appMainExposesLegacyPackageMigrationStub() {
        String src = read("app/src/main/java/ca/toadlybroodledev/minimalist/AppMain.java");
