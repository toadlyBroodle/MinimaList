 ...
 *
 * repositoryImplHoldsDatabaseReference: OutlineRepositoryImpl must hold a MinimaListDatabase
...
public class Phase9TransactionTest {
    ...
    public void repositoryImplHoldsDatabaseReference() {
        String src = readSource(DB_DIR + "OutlineRepositoryImpl.java");
        assertTrue("OutlineRepositoryImpl must hold a MinimaListDatabase reference " +
