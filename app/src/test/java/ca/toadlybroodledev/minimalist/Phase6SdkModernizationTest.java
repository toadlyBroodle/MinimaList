...
public class Phase6SdkModernizationTest {
    ...
    public void mainActivityOnBackPressedCallsSuper() {
        String src = readSource("app/src/main/java/ca/toadlybroodledev/minimalist/MainActivity.java");
    ...
    public void noFabClassReferenceInLayouts() {
        for (String path : allLayoutXmls()) {
            ...
            assertFalse("Layout " + path + " must not reference ca.toadlybroodledev.minimalist.Fab"
                    + " (class does not exist; use OutlineFab — MissingClass lint error causes runtime crash)",
                    xml.contains("ca.toadlybroodledev.minimalist.Fab"));
        }
    }
    ...
    public void externalStoragePathUsesAppScopedDir() {
        String src = readSource("app/src/main/java/ca/toadlybroodledev/minimalist/OutlineStore.java");
    ...
    public void pendingIntentsFlagImmutableWidgetProvider() {
        String src = readSource("app/src/main/java/ca/toadlybroodledev/minimalist/WidgetProvider.java");
    ...
    public void pendingIntentsFlagImmutableOutlineRowView() {
        String src = readSource("app/src/main/java/ca/toadlybroodledev/minimalist/OutlineRowView.java");
    ...
    public void pendingIntentsFlagImmutableReceiverNotification() {
        String src = readSource("app/src/main/java/ca/toadlybroodledev/minimalist/ReceiverNotification.java");
    ...
    public void noRawGetSystemServiceStrings() {
        String mainSrc = readSource("app/src/main/java/ca/toadlybroodledev/minimalist/MainActivity.java");
        String rcvSrc = readSource("app/src/main/java/ca/toadlybroodledev/minimalist/ReceiverNotification.java");
    ...
    public void drawerLayoutUsesNamedLockModeConstants() {
        String drawerToggleSrc = readSource(
                "app/src/main/java/ca/toadlybroodledev/minimalist/DrawerToggle.java");
