...
public class RootPackagePortTest {
    ...
    public void clipboardClassExists() {
        assertEquals("ca.toadlybroodledev.minimalist.Clipboard",
    ...
    public void appSettingsClassExists() {
        assertEquals("ca.toadlybroodledev.minimalist.AppSettings",
    ...
    public void outlineTreeClassExists() {
        assertEquals("ca.toadlybroodledev.minimalist.OutlineTree",
    ...
    public void outlineRowViewClassExists() {
        assertEquals("ca.toadlybroodledev.minimalist.OutlineRowView",
    ...
    public void indentManagerClassExists() {
        assertEquals("ca.toadlybroodledev.minimalist.IndentManager",
                IndentManager.class.getName());
    }

    @Test
    public void indentManagerHasRenderMethod() throws Exception {
        Method m = IndentManager.class.getDeclaredMethod("m4983a", OutlineFragment.class);
        assertNotNull(m);
    }
    ...
    public void sublistRendererClassExists() {
        assertEquals("ca.toadlybroodledev.minimalist.SublistRenderer",
    ...
    public void dateTimeUtilClassExists() {
        assertEquals("ca.toadlybroodledev.minimalist.DateTimeUtil",
    ...
    public void newSublistDialogClassExists() {
        assertEquals("ca.toadlybroodledev.minimalist.NewSublistDialog",
    ...
    public void drawerToggleClassExists() {
        assertEquals("ca.toadlybroodledev.minimalist.DrawerToggle",
    ...
    public void sublistFragmentClassExists() {
        assertEquals("ca.toadlybroodledev.minimalist.OutlineFragment",
                OutlineFragment.class.getName());
    }

    @Test
    public void sublistFragmentImplementsOutlineHost() {
        Set<String> ifaces = Arrays.stream(OutlineFragment.class.getInterfaces())
                .map(Class::getName)
                .collect(Collectors.toSet());
        assertTrue("OutlineFragment must implement OutlineHost",
                ifaces.contains("ca.toadlybroodledev.minimalist.iface.OutlineHost"));
    }

    // ---- WelcomeFragment ----------------------------------------------

    @Test
    public void welcomeFragmentExtendsOutlineFragment() {
        assertEquals(OutlineFragment.class, WelcomeFragment.class.getSuperclass());
    }
    ...
    public void settingsDialogClassExists() {
        assertEquals("ca.toadlybroodledev.minimalist.SettingsDialog",
    ...
    @Test
    public void searchFragmentExtendsOutlineFragment() {
        assertEquals(OutlineFragment.class, SearchFragment.class.getSuperclass());
    }

    @Test
    public void searchFragmentImplementsFragmentHost() {
        Set<String> ifaces = Arrays.stream(SearchFragment.class.getInterfaces())
                .map(Class::getName)
                .collect(Collectors.toSet());
        assertTrue("SearchFragment must implement FragmentHost",
                ifaces.contains("ca.toadlybroodledev.minimalist.iface.FragmentHost"));
    }
    ...
    public void settingsFragmentClassExists() {
        assertEquals("ca.toadlybroodledev.minimalist.SettingsFragment",
    ...
    public void drawerCustomLayoutHasAddSublistMethod() throws Exception {
        Method m = DrawerCustomLayout.class.getDeclaredMethod("m4798a", OutlineFragment.class);
        assertNotNull(m);
    }
    ...
    public void mainActivityImplementsHostContract() {
        ...
        assertTrue("MainActivity must implement HostContract",
                ifaces.contains("ca.toadlybroodledev.minimalist.iface.HostContract"));
    }
    ...
    public void mainActivityImplementsRowActionListener() {
        ...
        assertTrue("MainActivity must implement RowActionListener",
                ifaces.contains("ca.toadlybroodledev.minimalist.iface.RowActionListener"));
    }
