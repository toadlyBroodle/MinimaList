 ...
 * sublistDatabaseDeclaresVersion1: MinimaListDatabase.java must set version = 1 and reference
...
public class Phase9RoomSchemaTest {
    ...
    private static final String ENTITY_DIR =
            "app/src/main/java/ca/toadlybroodledev/minimalist/db/entity/";
    private static final String DAO_DIR =
            "app/src/main/java/ca/toadlybroodledev/minimalist/db/dao/";
    private static final String DB_DIR =
            "app/src/main/java/ca/toadlybroodledev/minimalist/db/";
    ...
    public void sublistDatabaseDeclaresVersion1() {
        String src = readSource(DB_DIR + "MinimaListDatabase.java");
        assertTrue("MinimaListDatabase must extend RoomDatabase",
                src.contains("RoomDatabase") || src.contains("extends RoomDatabase"));
        assertTrue("MinimaListDatabase must set version = 1",
                src.contains("version = 1") || src.contains("version=1"));
        assertTrue("MinimaListDatabase must reference SublistEntity",
                src.contains("SublistEntity"));
        assertTrue("MinimaListDatabase must reference OutlineRowEntity",
