...
public class Phase10MenuSurfacePruneTest {
    ...
    public void hostContractDropsProfileGetter() {
        String src = read("app/src/main/java/ca/toadlybroodledev/minimalist/iface/HostContract.java");
        ...
        assertFalse("HostContract must not import ProfileFragment (Phase 10.4)",
                src.contains("import ca.toadlybroodledev.minimalist.ProfileFragment"));
    }

    @Test
    public void mainActivityDropsProfileWiring() {
        String src = read("app/src/main/java/ca/toadlybroodledev/minimalist/MainActivity.java");
    ...
    public void outlineTreeDropsProfileCall() {
        String src = read("app/src/main/java/ca/toadlybroodledev/minimalist/OutlineTree.java");
    ...
    public void drawerCustomLayoutDropsProfileCase() {
        String src = read(
                "app/src/main/java/ca/toadlybroodledev/minimalist/DrawerCustomLayout.java");
