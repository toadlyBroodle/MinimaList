...
public class Phase9Wiring92aTest {
    ...
    private static final String PKG = "app/src/main/java/ca/toadlybroodledev/sublist/";

    @Test
    public void appMainHoldsRepositoryAndDatabaseSingletons() {
        String src = readSource(PKG + "AppMain.java");
        assertTrue("AppMain must hold a SublistDatabase reference",
    ...
    public void outlineStoreAutosavePathRemoved() {
        ...
        // Heuristic: the method must no longer reference SublistFragment.m4892a in a code path
