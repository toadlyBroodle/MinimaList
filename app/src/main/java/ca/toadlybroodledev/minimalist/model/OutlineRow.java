package ca.toadlybroodledev.minimalist.model;
...
public class OutlineRow implements Serializable {
    ...
    public static ArrayList<OutlineRow> getListOfEntSers(ArrayList<ca.toadlybroodledev.minimalist.OutlineRowView> rows) {
        ArrayList<OutlineRow> result = new ArrayList<>();
        for (ca.toadlybroodledev.minimalist.OutlineRowView rv : rows) {
