...
import ca.toadlybroodledev.minimalist.iface.OutlineHost;
...
public class OutlineFragment extends Fragment implements OutlineHost {
    ...
    private static final String f3900b = "fuckn" + OutlineFragment.class.getSimpleName();

    private static int f3898ao = -1;
    private static int f3899ap = -1;

    public static ArrayList<OutlineFragment> m4891a(HostContract host,
            HashMap<String, ArrayList<OutlineRow>> map) {
        ArrayList<OutlineFragment> result = new ArrayList<>();
        for (String key : map.keySet()) {
            result.add(new OutlineFragment().m4899a(host, key, map.get(key)));
        }
        return result;
    }

    public static HashMap<String, ArrayList<OutlineRow>> m4892a(ArrayList<OutlineFragment> frags) {
        HashMap<String, ArrayList<OutlineRow>> map = new HashMap<>();
        for (OutlineFragment frag : frags) {
            if (frag != null) {
    ...
    public OutlineFragment m4899a(HostContract host, String name, ArrayList<OutlineRow> rows) {
        f3901c = host;
        if (name == null) {
    ...
    public void onAttach(Context context) {
        ...
        // between onCreate (which adds WelcomeFragment without calling m4899a)
    ...
    public void onViewCreated(View view, Bundle savedState) {
        ...
        this.f3911al.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent e) {
                OutlineFragment.f3901c.mo4763a((OutlineRowView) null);
                return false;
            }
        });
        if (f3898ao == -1) {
    ...
    void m4906ao() {
        ...
        builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                list.add(OutlineFragment.this);
                OutlineFragment.f3901c.mo4768a(list, true);
            }
        });
