...
import ca.toadlybroodledev.sublist.iface.FragmentHost;
...
public class SearchSublistFragment extends SublistFragment
    ...
    public void onViewCreated(View view, Bundle savedState) {
        ...
        this.f3869g.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
                if (actionId == 6) {
                    try {
                        SearchSublistFragment.this.m4882c(textView);
                        return true;
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
    ...
    public ArrayList<OutlineRowView> m4883ad() {
        ArrayList<OutlineRowView> result = new ArrayList<>();
        for (SublistFragment frag : this.f3865c.mo4786x()) {
