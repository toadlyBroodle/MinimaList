...
public class MainActivity extends AppCompatActivity
    ...
    private ArrayList<OutlineFragment> f3702F;
    private int f3703G;
    ...
    public SearchFragment f3710t;
    public WelcomeFragment f3711u;
    ...
    void m4755B() {
        this.f3700D.loadAllFromRepo(saved -> {
            ...
            if (saved != null && !saved.isEmpty()) {
                mo4767a(OutlineFragment.m4891a(this, saved));
            } else {
                OutlineFragment frag = new OutlineFragment().m4899a(this, (String) null,
    ...
    public void mo4759F() {
        ...
        for (OutlineFragment sf : this.f3702F) {
    ...
    @Override
    public void mo4764a(OutlineFragment fragment) {
    ...
    @Override
    public void mo4767a(ArrayList<OutlineFragment> fragments) {
        FragmentTransaction tx = this.f3706p.beginTransaction();
        for (OutlineFragment frag : fragments) {
    ...
    @Override
    public void mo4768a(ArrayList<OutlineFragment> fragments, boolean z) {
    ...
    public void mo4769a(HashMap<String, ArrayList<OutlineRow>> map) {
        ArrayList<OutlineFragment> newFrags = new ArrayList<>();
        for (String key : map.keySet()) {
            newFrags.add(new OutlineFragment().m4899a(this, key, map.get(key)));
        }
    ...
    public void mo4771b(Fragment fragment) {
        if (fragment.getClass() == OutlineFragment.class) {
            this.f3697A.setText("");
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.f3710t = (SearchFragment) this.f3706p.findFragmentByTag(searchTag);
        this.f3711u = (WelcomeFragment) this.f3706p.findFragmentByTag(infoTag);
        if (this.f3709s == null) {
            this.f3709s = new SettingsFragment();
            tx.add(R.id.placeholder_for_fragments, this.f3709s, settingsTag);
        }
        if (this.f3710t == null) {
            this.f3710t = new SearchFragment();
            tx.add(R.id.placeholder_for_fragments, this.f3710t, searchTag);
        }
        if (this.f3711u == null) {
            this.f3711u = new WelcomeFragment();
    ...
    @Override
    public ArrayList<OutlineFragment> mo4786x() {
        return this.f3702F;
    }

    @Override
    public OutlineFragment mo4787y() {
        if (this.f3703G == -1) {
            return null;
        }
