...
/* JADX INFO: renamed from: com.google.android.gms.ads.internal.gmsg.y */
/* JADX INFO: loaded from: classes.dex */
final class C0778y implements InterfaceC0748aa<InterfaceC1758mv> {
    C0778y() {
    }
    ...
    public final /* synthetic */ void zza(InterfaceC1758mv interfaceC1758mv, Map map) {
        ...
        if (map.keySet().contains("start")) {
            interfaceC1758mv2.mo11833w().m11871i();
        } else if (map.keySet().contains("stop")) {
            interfaceC1758mv2.mo11833w().m11872j();
        } else if (map.keySet().contains("cancel")) {
            interfaceC1758mv2.mo11833w().m11873k();
        }
    }
}
