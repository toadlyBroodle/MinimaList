...
public final class amp extends akb {
    ...
    protected final arh<?> mo8073a(aii aiiVar, arh<?>... arhVarArr) {
        ...
        if ((Double.isInfinite(dM8079b) && dM8079b2 == 0.0d) || (dM8079b == 0.0d && Double.isInfinite(dM8079b2))) {
            return new arl(Double.valueOf(Double.NaN));
        }
        if (Double.isInfinite(dM8079b) || Double.isInfinite(dM8079b2)) {
            return new arl(Double.valueOf(((((double) Double.compare(dM8079b, 0.0d)) > 0.0d ? 1 : (((double) Double.compare(dM8079b, 0.0d)) == 0.0d ? 0 : -1)) < 0) ^ (((double) Double.compare(dM8079b2, 0.0d)) < 0.0d) ? Double.NEGATIVE_INFINITY : Double.POSITIVE_INFINITY));
        }
