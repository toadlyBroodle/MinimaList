...
public final class amy extends akb {
    ...
    protected final arh<?> mo8073a(aii aiiVar, arh<?>... arhVarArr) {
        ...
        return Pattern.compile(arhVarArr.length < 2 ? "" : aka.m8083d(arhVarArr[1])).matcher(((art) arhVarArr[0]).mo8208b()).find() ? new arl(Double.valueOf(r1.start())) : new arl(Double.valueOf(-1.0d));
    }
}
