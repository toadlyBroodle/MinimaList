...
public final class alc extends akb {
    ...
    protected final arh<?> mo8073a(aii aiiVar, arh<?>... arhVarArr) {
        ...
        if ((((artVar instanceof art) && (artVar2 instanceof art)) || (!Double.isNaN(aka.m8079b(artVar)) && !Double.isNaN(aka.m8079b(artVar2)))) && !aka.m8080b(artVar, artVar2)) {
            z = true;
        }
