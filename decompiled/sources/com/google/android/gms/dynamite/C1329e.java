...
final class C1329e implements DynamiteModule.InterfaceC1324d {
    C1329e() {
    }
    ...
    public final C1334j mo7342a(Context context, String str, InterfaceC1333i interfaceC1333i) {
        ...
        if (c1334j.f6079a != 0) {
            c1334j.f6080b = interfaceC1333i.mo7341a(context, str, false);
        } else {
            c1334j.f6080b = interfaceC1333i.mo7341a(context, str, true);
        }
        if (c1334j.f6079a == 0 && c1334j.f6080b == 0) {
            c1334j.f6081c = 0;
        } else if (c1334j.f6079a >= c1334j.f6080b) {
            c1334j.f6081c = -1;
        } else {
            c1334j.f6081c = 1;
        }
