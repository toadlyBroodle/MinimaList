...
- [ ] 4.5 [medium] Port the remaining 3 already-named classes (`ActMain`, `AppMain`, `WidgetProvider`); `R.java` is generated, not copied — delete the decompiled one. (`ReceiverNotification`, `Fab`/`OutlineFab`, `DrawerCustomLayout` ported in 4.4.)
