...
- [easy] [should-fix] `Phase9SettingsFragmentLifecycleTest.java:47` — 4 tests use file-wide src.contains(); removing the guard from one method passes all 4 — review of 815d6a2
